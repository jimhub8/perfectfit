...
<div>
    ...
    <v-layout wrap>
        <v-flex xs12 style="padding: 7px 10px 20px 10px;">
            <label for="" style="color: #52627d;">Main Categories</label>
            <el-select v-model="product.menus" multiple filterable clearable placeholder="Select menus" style="width:100%;" value-key="id">
