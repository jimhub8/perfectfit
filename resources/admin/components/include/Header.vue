...
<v-app id="inspire">
            ...
            <template>
                <v-card>
                    ...
                    <router-link to="/schools" class="v-list-item v-list-item--link theme--light">
                        ...
                        <div class="v-list-item__content">
                            <div class="v-list-item__title">School</div>
                        </div>
                    </router-link>
                    <router-link to="/sellers" class="v-list-item v-list-item--link theme--light">
                        <div class="v-list__tile__action">
    ...
    <v-footer style="background: #e2e0e0 !important;" app>
        <span style="color: #000; margin: auto;">Perfectfit &copy; {{ new Date().getFullYear() }}</span>
    </v-footer>
